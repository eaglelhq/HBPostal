...
public class PullToRefreshScrollView extends PullToRefreshBase<BottomScrollView> {
	...
	@Override
	protected BottomScrollView createRefreshableView(Context context, AttributeSet attrs) {
		BottomScrollView scrollView;
//		if (VERSION.SDK_INT >= VERSION_CODES.GINGERBREAD) {
//			scrollView = new InternalScrollViewSDK9(context, attrs);
//		} else {
			scrollView = new BottomScrollView(context, attrs);
//		}
