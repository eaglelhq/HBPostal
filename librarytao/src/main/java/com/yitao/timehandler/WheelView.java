...
public class WheelView extends View {
	 ...
	 * 当前选中的颜色，和label的颜色
	 */
	private static final int VALUE_TEXT_COLOR = R.color.textColor_blue;
	/**
	 * 选中的颜色
	 */
	private static final int ITEMS_TEXT_COLOR = R.color.time_selected;
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(getContext().getResources().getColor(ITEMS_TEXT_COLOR));
