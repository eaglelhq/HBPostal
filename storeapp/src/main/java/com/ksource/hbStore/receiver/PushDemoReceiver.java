package com.ksource.hbStore.receiver;
...
import com.ksource.hbStore.util.NotificactionUtils;
...
//                    payloadData.append("\n");
                    ...
                    PayResultBean resultBean = new Gson().fromJson(data, PayResultBean.class);
                    if (resultBean != null && resultBean.content!= null) {
//                        Intent intent1 = new Intent(context, ReceiveMoneyActivity.class);
//                        intent1.putExtra("money", resultBean.content.TOTAL_AMOUNT);
//                        intent1.putExtra("time", resultBean.content.PAY_TIME);
//                        intent1.putExtra("orderId", resultBean.content.MESSAGEID);
//                        intent1.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                        context.startActivity(intent1);
                        NotificactionUtils.getInstance().addMessageNotificaction(context, resultBean, token);
                    }
                }
                break;
