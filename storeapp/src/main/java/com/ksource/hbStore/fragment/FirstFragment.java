...
import com.ksource.hbStore.activity.SetMoneyActivity;
...
//		getCode();
        id = spUtils.getString(ConstantValues.USER_ID);
        name = spUtils.getString(ConstantValues.USER_NAME);
        sellerId = spUtils.getString(ConstantValues.SELLER_ID);
