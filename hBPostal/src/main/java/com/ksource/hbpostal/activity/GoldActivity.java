...
import com.ksource.hbpostal.fragment.GoldActiveFragment;
import com.ksource.hbpostal.fragment.SubGoldFragment;
 ...
 * 金邮币信息页面
 */
public class GoldActivity extends BaseFragmentActivity {
...
//			Intent intent = new Intent(context, GoldExplainActivity.class);
...
//			startActivity(new Intent(context, MainActivity.class));
	...
	public void initData() {
		datas.add(new GoldActiveFragment());
		datas.add(new SubGoldFragment());
		// 添加Viewpager适配器
