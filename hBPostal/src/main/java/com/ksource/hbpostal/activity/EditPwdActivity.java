...
//			state = has_pay_pwd ? "修改":"设置"+state;
//			et_qr_pwd.setFilters(new InputFilter[]{new InputFilter.LengthFilter(6)});
//			et_new_pwd.setFilters(new InputFilter[]{new InputFilter.LengthFilter(6)});
//			et_new_pwd.setInputType(InputType.TYPE_NUMBER_VARIATION_PASSWORD);
//			et_qr_pwd.setInputType(InputType.TYPE_NUMBER_VARIATION_PASSWORD);
//		}
...
//					}else{
//						dialog.setTitleText(state+"成功！").setContentText(pwdResult.msg)
//								.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
//							@Override
//							public void onClick(
//									SweetAlertDialog sweetAlertDialog) {
