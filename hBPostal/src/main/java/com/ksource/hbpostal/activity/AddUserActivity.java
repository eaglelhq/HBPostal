...
//	private String typeName = "";
	...
	public void initView() {
		...
		tv_title.setText("新增家庭");
		iv_back = (ImageView) findViewById(R.id.iv_back);
		tv_home = (TextView) findViewById(R.id.tv_home);
		tv_area = (TextView) findViewById(R.id.tv_area);
		et_addr = (EditText) findViewById(R.id.et_addr);
		btn_save = (Button) findViewById(R.id.btn_save);
		ll_other_name = (LinearLayout) findViewById(R.id.ll_other_name);
	}
			...
			public void onResponse(String arg0, int arg1) {
				...
				if (homeResultBean == null) {
					...
					if (homeResultBean.success) {
						...
						if (isFirst) {
							homeName = homeList.get(0).HOME_NAME;
...
//				params.put("typeKey", typeKey);
					...
					if (homeResultBean.success) {
						...
						.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
							...
							public void onClick(SweetAlertDialog sweetAlertDialog) {
								...
								finish();
								mApplication.finishActivity("EditUserActivity");
		...
		DataUtil.doPostAESData(mLoadDialog,context,ConstantValues.ADD_HOME_URL, params, callback);
	}
...
//				if ("其他".equals(itemDatas[which])) {
//					ll_other_name.setVisibility(View.VISIBLE);
//				}else{
//					ll_other_name.setVisibility(View.GONE);
//				}
