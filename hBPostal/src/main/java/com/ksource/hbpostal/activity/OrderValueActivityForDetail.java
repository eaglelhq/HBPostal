...
public class OrderValueActivityForDetail extends BaseActivity{
...
//		orderId = getIntent().getStringExtra("orderId");
		goodsBean = (GoodsListBean) getIntent().getSerializableExtra("goodsBean");
		tv_goods_name.setText(goodsBean.GOODS_NAME);
		try {
			ImageLoaderUtil.loadNetPic(
					ConstantValues.BASE_URL + goodsBean.IMAGE,
					iv_goods_icon);
	...
	private void submitValue() {
		...
		StringCallback callback = new StringCallback() {
			...
			public void onResponse(String arg0, int arg1) {
				...
				Gson gson = new Gson();
				final BaseResultBean baseResult = gson.fromJson(arg0,
