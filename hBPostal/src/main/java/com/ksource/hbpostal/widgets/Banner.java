...
//	private OnClickPicLinstener listener;
...
//		delayTime = 2500;
	...
	private void initImgFromRes(int[] imagesRes) {
		...
		for (int i = 0; i < count; i++) {
			...
			iv_dot.setImageResource(R.drawable.dot_gray);
			ll_dot.addView(iv_dot, params);
			iv_dots.add(iv_dot);
		}
		iv_dots.get(0).setImageResource(R.drawable.dot_green);
...
//			 iv.setBackgroundResource(R.drawable.plugin_camera_no_pictures);
			if (i == 0) {
	...
	class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			for (int i = 0; i < iv_dots.size(); i++) {
				if (i == arg0 - 1) {
					iv_dots.get(i).setImageResource(R.drawable.dot_green);
				} else {
					iv_dots.get(i).setImageResource(R.drawable.dot_gray);
				}
			}
...
//	public void setOnClickPicLinstener(OnClickPicLinstener listener) {
//		this.listener = listener;
//	}
//
//	public interface OnClickPicLinstener {
