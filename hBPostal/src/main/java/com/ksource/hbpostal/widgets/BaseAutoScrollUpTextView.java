...
//				viewHolder.mTitleView2 = (TextView) convertView
//						.findViewById(R.id.tv_title2);
//				viewHolder.mInfoView2 = (TextView) convertView
//						.findViewById(R.id.tv_info2);
			...
			viewHolder.mTitleView.setLayoutParams(new RelativeLayout.LayoutParams(
...
//			viewHolder.mTitleView2.setTextSize(mSize);
//			viewHolder.mInfoView2.setTextSize(mSize);
//			viewHolder.mTitleView2.setText(getText2Title(data));
//			viewHolder.mInfoView2.setText(getText2Info(data));
...
//		TextView mTitleView2;// 标题
//		TextView mInfoView2;// 内容
	}
