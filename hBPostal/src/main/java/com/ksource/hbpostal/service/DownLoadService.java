...
public class DownLoadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        //设置想要展示的数据内容
        final Intent intent_noti = new Intent();
        intent_noti.setAction(Intent.ACTION_VIEW);
        intent_noti.addCategory("android.intent.category.DEFAULT");
        //文件的类型，从tomcat里面找
        ...
        String ticker = "正在更新邮支付";
        //实例化工具类，并且调用接口
        NotifyUtil notify7 = new NotifyUtil(this, 7);
        notify7.notify_progress(rightPendIntent, smallIcon, ticker, "邮支付升级程序", "正在下载中",
